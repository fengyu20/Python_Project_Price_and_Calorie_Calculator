from meal_counter.functions import calorie_counter, price_counter, load_json, combo_ids_dict, meal_ids_dict
import pandas as pd
...
# create a function that takes meal_id as arguments and return names
